...
from tenants.views import ShopViewSet, EmployeeViewSet, RegisterMerchantView, ShopSettingsView
...
urlpatterns = router.urls + [
    ...
    path("shops/<uuid:shop_pk>/settings/", ShopSettingsView.as_view(), name="shop-settings"),
